...
export async function POST(req: Request) {
  try {
    ...
    const tenth_marks_id = formData.get("tenth_marks_id") as string;
    const twelfth_marks_id = formData.get("twelfth_marks_id") as string;
    const bachelor_marks_id = formData.get("bachelor_marks_id") as string;
    ...
    for (const fileKey of requiredFiles) {
      ...
      // Allow image files for profile_img, require PDF for other documents
